...
\begin{document}
\mkheader{William Cromar}{williamcromar58@gmail.com}{904-814-9428}
...
\begin{itemize}
  \item Migrate test result dashboard tool \emph{Testgrid} (written in \resskill{Go}) from \resskill{Google App Engine} Standard to \resskill{Kubernetes}-based serverless application framework \emph{Knative}, decreasing response latency by an average of 50%.
  \item Create reproducible performance benchmark to compare baseline and new versions of TestGrid. Analyze, interpret, and present performance data to appropriate teams, along with actionable feedback on how to improve developer experience and productivity with \emph{Knative}-based Cloud products.
\end{itemize}
